                     ...
                     _In_ int       nCmdShow)
{
    ...
    while (true)
    {
        if (PeekMessage(&msg, nullptr, 0, 0, PM_REMOVE))
        {
            ...
            //TranslateAccelerator : 단축키 관련 기능
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   g_hWnd = CreateWindowW(L"MyWindow", L"MyGame", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX,
