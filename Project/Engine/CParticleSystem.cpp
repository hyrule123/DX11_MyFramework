	...
	, m_bIsCreated()
{
	...
	UINT ShaderTarget = def_Shader::eSHADER_PIPELINE_STAGE::__GEOMETRY | def_Shader::eSHADER_PIPELINE_STAGE::__PIXEL;
	...
	//컴퓨트쉐이더 전용
	m_pSBufferRW_Shared = new CStructBuffer(tSBufferDesc{ eSTRUCT_BUFFER_TYPE::READ_WRITE, def_Shader::eSHADER_PIPELINE_STAGE::__NONE, eCBUFFER_SBUFFER_SHAREDATA_IDX::NONE,idx_t_SRV_NONE, idx_u_PARTICLE_SBUFFERRW_SHAREDATA });
}
...
void CParticleSystem::finaltick()
{
	...
	//s_CBuffer_ModuleData->BindBuffer(def_Shader::eSHADER_PIPELINE_STAGE::__ALL);
