...
CParticleSystem::CParticleSystem()
	...
	, m_bIsCreated()
{
	SetMesh(CResMgr::GetInst()->FindRes<CMesh>(string(RES_DEFAULT::MESH::POINT)));
	SetMaterial(CResMgr::GetInst()->FindRes<CMaterial>(string(RES_DEFAULT::MATERIAL::PARTICLE_RENDER)));
