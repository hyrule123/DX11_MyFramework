...
void cCollisionMgr::tick()
{
	...
	while (iter != iterEnd)
	{
		...
		{
			iter->second.pcColliderA->EndCollision(iter->second.pcColliderB);
...
bool cCollisionMgr::CheckCollision2D_Rect_Circle(cCollider2D* _pColRect, cCollider2D* _pColCircle, Vec2& _v2HitPoint)
{
	...
	if (isOdd)
	{
		...
		{
			ComputeHitPointByRectLBRT(_pColRect->GetSimplecCollider(), _pColCircle->GetSimplecCollider(), _v2HitPoint);
			return true;
		}
	}
...
bool cCollisionMgr::CheckCollision2D_Circle_Circle(cCollider2D* _pColCircle_1, cCollider2D* _pColCircle_2, Vec2& _v2HitPoint)
{
	...
	ComputeHitPointByRectLBRT(_pColCircle_1->GetSimplecCollider(), _pColCircle_2->GetSimplecCollider(), _v2HitPoint);
...
bool cCollisionMgr::CheckCollision2D_OBB_OBB(cCollider2D* _pColOBB2D_1, cCollider2D* _pColOBB2D_2, Vec2& _v2HitPoint)
{
	...
	ComputeHitPointByRectLBRT(_pColOBB2D_1->GetSimplecCollider(), _pColOBB2D_2->GetSimplecCollider(), _v2HitPoint);
