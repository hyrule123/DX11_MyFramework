...
//=============사용법============
//컴퓨트쉐이더의 HLSL 코드는 C++ C_ComputeShader 클래스에 종속됨
//하나의 HLSL CS = 하나의 C_ComputeShader 클래스
...
public:
    ...
    virtual ~C_ComputeShader();
    CLONE_DISABLE(C_ComputeShader);
...
private:
    ...
    vector<std::shared_ptr<C_CShaderModule>> m_vecShaderModule;
...
inline HRESULT C_ComputeShader::CreateShader(ComPtr<ID3DBlob> _pBlob)
{
