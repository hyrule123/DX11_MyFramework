...
private:
    Collider() = delete;
public:
    Collider(eCOMPONENT_TYPE _ComType, eDIMENSION_TYPE _eDim);
    virtual ~Collider();
...
public:
    void BeginCollision(Collider* _other, const Vec3& _v3HitPoint);
    ...
    ScriptHolder* ScriptHolder() { return GetOwner()->ScriptHolder(); }
