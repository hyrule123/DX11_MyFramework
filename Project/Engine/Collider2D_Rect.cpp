...
Collider2D_Rect::Collider2D_Rect()
	: Collider2D(eCOLLIDER_TYPE_2D::RECT)
{
}

Collider2D_Rect::Collider2D_Rect(eCOLLIDER_TYPE_2D _Type)
	: Collider2D(_Type)
{
}
...
bool Collider2D_Rect::SaveJson(Json::Value* _pJVal)
{
	if (nullptr == _pJVal)
		return false;
...
bool Collider2D_Rect::LoadJson(Json::Value* _pJVal)
{
	if (nullptr == _pJVal)
		return false;
...
void Collider2D_Rect::UpdateCollider()
{
	Collider2D::UpdateCollider();
}

void Collider2D_Rect::UpdateSimpleCollider(Vec4& _vSimpleCollLBRTPos)
{
...
void Collider2D_Rect::DebugRender()
{
