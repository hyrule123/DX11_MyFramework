...
bool CCS_ParticleUpdate::BindDataCS()
{
	...
	m_pCBuffer_ModuleData->BindBuffer(def_Shader::eSHADER_PIPELINE_STAGE::__COMPUTE);

	m_Tex_Noise->BindData_SRV(idx_t_TEXUTRE_NOISE, def_Shader::eSHADER_PIPELINE_STAGE::__COMPUTE);
