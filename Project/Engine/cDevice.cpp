...
int cDevice::init(HWND _hWnd, UINT _uWidth, UINT _uHeight)
{
    ...
    {
        MessageBox(nullptr, L"cDevice, Context 생성 실패", L"cDevice 초기화 에러", MB_OK);
        return E_FAIL;
    }

    if (FAILED(CreateSwapChain()))
    {
        MessageBox(nullptr, L"스왑체인 생성 실패", L"cDevice 초기화 에러", MB_OK);
        return E_FAIL;
    }

    if (FAILED(CreateView()))
    {
        MessageBox(nullptr, L"View 생성 실패", L"cDevice 초기화 에러", MB_OK);
        return E_FAIL;
    }
    ...
    {
        MessageBox(nullptr, L"Sampler 생성 실패", L"cDevice 초기화 에러", MB_OK);
        return E_FAIL;
    }
