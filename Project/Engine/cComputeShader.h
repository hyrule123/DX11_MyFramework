...
private:
    std::unique_ptr<cCShaderModule> m_pShaderModule;
public:
    bool AddShaderModule(std::unique_ptr<cCShaderModule>&& _pShaderModule);
    cCShaderModule* GetShaderModule() { return m_pShaderModule.get(); }
