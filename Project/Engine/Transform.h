...
inline void Transform::SetSize(const Vec3& _vSize)
{
    m_v3Size = _vSize;
    m_bSizeUpdated = true;
}

inline void Transform::SetSizeXY(const Vec2& _v2Size)
{
    m_v3Size = _v2Size;
    m_bSizeUpdated = true;
}

inline void Transform::SetRelativeScale(const Vec3& _vScale)
{ 
...
inline void Transform::SetRelativeScale(float _x, float _y, float _z)
{
...
inline Vec3 Transform::GetWorldRot(eAXIS3D _eAxis) const
{
    return m_matWorldWithoutSize.Axis((UINT)_eAxis).Normalize();
}

inline void Transform::ClearUpdateState()
{
