...
public:
    ...
    virtual eRENDER_RESULT Render() = 0;
...
inline void IRenderer::SetMaterial(Ptr<cMaterial> _Mtrl)
{
    m_pSharedMtrl = _Mtrl;
...
inline Ptr<cMaterial> IRenderer::GetSharedMaterial()
{ 
    m_pCurrentMtrl = m_pSharedMtrl;
