...
#define MTRL_SCALAR_MAT_VIEW                    MTRLDATA_PARAM_SCALAR(MAT_2)
#define MTRL_SCALAR_MAT_PROJ                    MTRLDATA_PARAM_SCALAR(MAT_3)



#define MTRL_SCALAR_STD2D_FLAG                  MTRLDATA_PARAM_SCALAR(INT_0)
#define MTRL_SCALAR_STD2D_ANIM_TEXATLAS_IDX     MTRLDATA_PARAM_SCALAR(INT_1)
