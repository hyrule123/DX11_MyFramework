...
void cCollider2D_OBB::UpdatecCollider()
{
	//충돌체 주소를 가져온다.
	...
	//부모의 동일함수를 호출(Simple cCollider 계산)
	cCollider2D::UpdatecCollider();
}

void cCollider2D_OBB::UpdateSimplecCollider(Vec4& _vSimpleCollLBRTPos)
{
