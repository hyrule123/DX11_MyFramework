...
bool CCS_Initialize::BindDataCS()
{
	...
	m_pSBuffer_InitSetting = new CStructBuffer(tSBufferDesc{ eSTRUCT_BUFFER_TYPE::READ_WRITE, define_Shader::eSHADER_PIPELINE_STAGE::__ALL, eCBUFFER_SBUFFER_SHAREDATA_IDX::NONE, idx_t_INIT_SETTING, idx_u_INIT_SETTING });
